...
//code from this navigation activity was supported by https://github.com/vikesh8860/QuizBook
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (Button) findViewById(R.id.study);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressBar.setMessage("Let's get studying ...");//Title shown in the progress bar
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(NavigationActivity.this, Study.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_Activities.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_Services.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_ContentProviders.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_BroadcastReceivers.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_ActivityLifecycle.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_CodeSummary.class);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Intent start to open the navigation drawer activity
                        progressBar.cancel();//Progress bar will be cancelled (hide from screen) when this run function will execute after 3.5seconds
                        Intent intent = new Intent(NavigationActivity.this, QuizActivity_ModuleSummary.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Setting) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Quizard - INFS3634 Learning App");
            System.out.println("Take a look at this app for INFS3634"+R.string.email_content);
            ...
            intent.setData(Uri.parse("mailto:"));
            String[] recipents = {"z5164871@ad.unsw.edu.au"};
            intent.setType("message/rfc822");
            intent.putExtra(Intent.EXTRA_EMAIL, recipents);
            intent.putExtra(Intent.EXTRA_SUBJECT, "Quizard App Feedback");
